    ...
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-800 pb-6">
        <div>
          ...
          <p className="text-zinc-400">Comprehensive guides for the Zentari protocol.</p>
        </div>
        <div className="flex items-center gap-3">
          <button
            onClick={handleDownload}
            className="flex items-center gap-2 px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-white rounded-lg transition-colors border border-zinc-700 text-sm"
          >
            <Download size={16} />
            <span>Current</span>
          </button>
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-brand-ink rounded-lg transition-colors font-bold text-sm"
          >
            <Download size={16} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-2">
          {(Object.keys(docs) as DocType[]).map((key) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <Icon size={20} />
                  <span className="font-medium">{docs[key].title}</span>
                </div>
          ...
          <div className="mt-8 p-4 bg-zinc-900/50 border border-zinc-800 rounded-xl space-y-4">
            <h3 className="text-sm font-semibold text-zinc-300 uppercase tracking-wider">Resources</h3>
        ...
        <div className="lg:col-span-3">
          <motion.div
            ...
            className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 prose prose-invert prose-emerald max-w-none shadow-2xl"
          >
