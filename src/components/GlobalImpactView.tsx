...
export const GlobalImpactView = () => (
  <div className="space-y-8 md:space-y-12">
    <div className="space-y-2 md:space-y-3">
      <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Global Impact</h2>
      <p className="text-brand-muted text-base md:text-lg">The real-world outcomes of the Zentari protocol.</p>
    </div>
    ...
    <div className="p-10 md:p-20 border border-brand-border rounded-3xl md:rounded-[3rem] bg-white/[0.01] flex items-center justify-center min-h-[300px] md:min-h-[400px]">
      <div className="text-center space-y-4 md:space-y-6">
        <Globe className="w-12 h-12 md:w-16 md:h-16 text-brand-muted mx-auto opacity-20" />
        <p className="text-brand-muted font-mono text-[9px] md:text-[10px] uppercase tracking-widest px-4">Interactive Global Impact Map Loading...</p>
      </div>
    </div>
  </div>
);
